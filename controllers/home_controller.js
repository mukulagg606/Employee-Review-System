...
// This function is for the passing the variable to the home page, such as reviewers array, and employee array
module.exports.home = async function(req, res){
    try{
        ...
        // taking all the necessary part of recipient user in recipient array so that we can pass it as a variable'
        let recipient = [];
